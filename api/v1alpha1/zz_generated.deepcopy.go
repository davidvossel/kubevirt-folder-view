...
func (in *ClusterFolderEntry) DeepCopyInto(out *ClusterFolderEntry) {
	*out = *in
	if in.ClusterFolderEntries != nil {
		...
		*out = make([]ClusterFolderEntry, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.NamespaceEntries != nil {
		in, out := &in.NamespaceEntries, &out.NamespaceEntries
		*out = make([]NamespaceEntry, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NamespaceEntry.
func (in *NamespaceEntry) DeepCopy() *NamespaceEntry {
	if in == nil {
		return nil
	}
	out := new(NamespaceEntry)
	in.DeepCopyInto(out)
	return out
}
